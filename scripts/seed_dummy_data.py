...
DEBTORS: list[dict[str, str]] = [
    ...
    {"name": "خالد الهمداتي", "phone": "+966500000003"},
...
PURCHASE_DATA = [
    {"desc": "زيت عافية 1.5 لتر", "amount": 18.00},
    {"desc": "طبق بيض 30 حبة", "amount": 20.00},
    {"desc": "أرز محمود 5 كيلو", "amount": 40.00},
    {"desc": "دجاج ساديا حلال 1000 جم", "amount": 19.00},
    {"desc": "لحم غنم طازج حلال 1 كيلو", "amount": 65.00},
    {"desc": "حليب المراعي 2 لتر", "amount": 11.00},
    {"desc": "جبنة بوك كاسات 500 جم", "amount": 16.00},
    {"desc": "كرتون مياه نوفا", "amount": 18.00},
    {"desc": "شامبو هيد آند شولدرز 400 مل", "amount": 25.00},
    {"desc": "مكرونة قودي 500 جم", "amount": 5.50},
]
