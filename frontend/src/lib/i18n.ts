...
const en: Translations = {
  ...
  landingHeadline: 'A digital debt notebook confirmed by both parties',
  landingPitch: 'A smart platform for managing digital debts between shop owners and their customers, and between friends and family. No notebooks, no disputes.',
  ...
  // Landing page v2
  landingFeaturesTitle: 'Why Thabetha?',
  landingHowItWorks: 'How does it work?',
  landingStep1Title: 'Record the debt',
  landingStep1Desc: 'The creditor creates the debt with the amount, date, and an optional description in seconds.',
  landingStep2Title: 'Both parties confirm',
  landingStep2Desc: 'The debtor receives an acceptance request and confirms it, making the debt binding on both parties.',
  landingStep3Title: 'Track & settle',
  landingStep3Desc: 'Automatic reminders, a live commitment indicator, and creditor confirmation of payment receipt.',
  landingF1Title: 'Bilateral confirmation',
  landingF1Desc: 'A debt only becomes official after both parties agree, preventing denial and disputes.',
  landingF2Title: 'QR code scanning',
  landingF2Desc: "Scan the customer's code to link their profile and create the debt without entering data manually.",
  landingF3Title: 'Commitment indicator',
  landingF3Desc: 'Every creditor has a commitment indicator (50–100) inside the platform as a public rating of how committed they are.',
  landingF4Title: 'Smart assistant',
  landingF4Desc: 'Record debts by voice, and get smart summaries and automatic recommendations.',
  landingF5Title: 'Automatic reminders',
  landingF5Desc: 'Scheduled alerts before due dates and on late payments, with an impact on the commitment indicator.',
  landingF6Title: 'Group debts',
  landingF6Desc: 'Automatic settlement of debts within the group with no shortfall or surplus.',
  landingCtaTitle: 'Start organizing your debts today',
  landingCtaDesc: 'Choose your role and continue to the demo dashboard.',
