...
from app.api import ai, auth, dashboards, debts, groups, health, notifications, profiles, qr, receipt_files, webhooks_payments, webhooks_whatsapp
...
api_router.include_router(webhooks_payments.router, tags=["webhooks"])
